...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded shadow-md overflow-hidden">
        <img src="{{ asset('images/news2.jpg') }}" alt="Berita 2" class="w-full h-48 object-cover">
        <div class="p-4">
            <h3 class="text-lg font-semibold text-blue-900 mb-2">Kegiatan Bakti Sosial Siswa</h3>
            <p class="text-gray-600 text-sm">Dipublikasikan: 5 Desember 2024</p>
        </div>
    </div>
</div>
@endsection
