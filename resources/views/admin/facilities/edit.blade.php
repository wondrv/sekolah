...
<div class="p-6">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Edit Fasilitas: {{ $facility->name }}</h1>
    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="facilities" name="facilities" rows="4"
                                  ...
                                  placeholder="Contoh:&#10;- AC&#10;- Proyektor&#10;- Sound System">{{ old('facilities', $facility->facilities) }}</textarea>
                        @error('facilities')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        @error('image')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-sm text-gray-500">Format: JPG, PNG, maksimal 2MB. Kosongkan jika tidak ingin mengubah.</p>
                    </div>

                    <div>
                        <label for="capacity" class="block text-sm font-medium text-gray-700 mb-2">Kapasitas</label>
                        <input type="number" id="capacity" name="capacity" value="{{ old('capacity', $facility->capacity) }}"
