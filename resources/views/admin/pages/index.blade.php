    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <!-- Berita & Artikel inside Pages table -->
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div>
                                <div class="text-sm font-medium text-gray-900">Berita & Artikel</div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">berita</div>
                        <div class="text-sm text-gray-500">
                            <a href="{{ url('/berita') }}" target="_blank" class="text-blue-600 hover:text-blue-900">
                                Lihat Halaman
                            </a>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            <a href="{{ route('admin.posts.index') }}" class="text-indigo-600 hover:text-indigo-900">Kelola</a>
                        </div>
                    </td>
                </tr>
                <!-- Event & Kegiatan inside Pages table -->
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div>
                                <div class="text-sm font-medium text-gray-900">Event & Kegiatan</div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900">events</div>
                        <div class="text-sm text-gray-500">
                            <a href="{{ url('/events') }}" target="_blank" class="text-blue-600 hover:text-blue-900">
                                Lihat Halaman
                            </a>
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            <a href="{{ route('admin.events.index') }}" class="text-indigo-600 hover:text-indigo-900">Kelola</a>
                        </div>
                    </td>
                </tr>
