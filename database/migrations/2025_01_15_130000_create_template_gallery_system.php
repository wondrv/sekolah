...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('template_gallery')) {
        ...
        if (!Schema::hasTable('template_exports')) {
        ...
        // Extend existing templates table (only if exists)
        if (Schema::hasTable('templates')) {
            Schema::table('templates', function (Blueprint $table) {
                ...
                if (!Schema::hasColumn('templates', 'template_version')) {
                    $table->string('template_version', 10)->default('1.0.0');
                }
